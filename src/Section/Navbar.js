...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="px-4 md:px-8 max-w-auto mx-auto xl:px-40">
          <div className="flex flex-row items-center lg:justify-between w-full justify-between py-4">
            ...
            <div className="hidden lg:flex items-center z-20">
              <button className="button font-bold text-base py-4 px-6">Contact Us</button>
            </div>
      ...
      <nav className="z-[50] [opacity-100] absolute top-0 left-0 w-full bg-transparent shadow-[0_1px_0_0_rgba(211,211,211,0.5)]">
        <div className="max-w-auto mx-auto px-0 lg:px-40 py-4">
          <div className="px-4 flex items-center justify-between h-[60px]">
            <div className="flex-shrink-0">
              <img src={logo} className="h-[40px] logo" alt="Logo" />
            </div>

            {/* Center NavLinks */}
            <div className="hidden xl:flex items-center justify-center flex-1 z-20">
              <div className="flex space-x-6">
