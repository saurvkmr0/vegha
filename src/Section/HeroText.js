  ...
  return (
    <div  className=''>
        <div className="w-full max-w-[800px] text-white flex flex-col gap-6 md:gap-10">
            ...
            <p className="text-5xl md:text-7xl xl:text-[80px] font-bold">Digital Services & IT Solutions</p>
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 ">
                <button className='button font-bold text-base py-4 px-6 max-w-[220px] '>Read More</button>
                <button className='button-outline font-bold text-base py-4 px-6 max-w-[220px] '>Our Services</button>
            </div>
        </div>
    </div>
  )
